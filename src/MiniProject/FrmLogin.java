...
public class FrmLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new java.awt.Font("Mitr Medium", 1, 18)); // NOI18N
        ...
        jLabel2.setFont(new java.awt.Font("Mitr Medium", 1, 14)); // NOI18N
    ...
    private void btnExitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExitActionPerformed
        String message = "คุณต้องการออกจากโปรแกรมหรือไ่ม่";
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        if (inpUser.equals("") || inpPass.equals("")) {
            ...
            try {
                ...
                try (PreparedStatement pstmt = myDB.prepareStatement(selectSql)) {
                    pstmt.setString(1, inpUser);
                    pstmt.setString(2, inpPass);
